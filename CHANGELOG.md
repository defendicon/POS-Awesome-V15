...
Release 15.36.0 — September 23, 2026
### ✨ Features
- add combined item exchange receipt printing (pos)
- add controlled item exchange cancellation and deletion (pos)
- add item exchange audit report and workspace links (pos)
- add linked item exchange with net settlement (pos)
- persist and recover item exchange sessions safely (pos)
- polish exchange settlement summary and unify calculations (pos)
_Total: 6 changes_

### 🐞 Bug Fixes
- handle missing payment field precision 
- resolve docs and ERPNext v16 workflow failures (ci)
- run ERPNext compatibility test from Frappe sites directory (ci)
- declare explicit pre and post model sync patch sections (migrate)
- sync exchange report before adding workspace link (migrate)
- correct exchange currency display and compact settlement layout (pos)
- harden item exchange lifecycle and settlement precision (pos)
- move exchange guidance below active sale and validate settlement (pos)
- preserve exchange settlement through payment submission (pos)
- remove unused space below exchange summary (pos)
- prevent pricing rules from repricing return invoices (returns)
_Total: 11 changes_
