	...
	methods: {
		...
		calculateColumnWidth(header) {
			const baseWidths = {
				...
				qty: { min: 90, max: 140, ratio: 0.15 },
				rate: { min: 80, max: 110, ratio: 0.12 },
				amount: { min: 80, max: 110, ratio: 0.12 },
				discount_value: { min: 60, max: 90, ratio: 0.1 },
				discount_amount: { min: 70, max: 100, ratio: 0.11 },
				price_list_rate: { min: 90, max: 120, ratio: 0.13 },
				actions: { min: 60, max: 80, ratio: 0.08 },
				posa_is_offer: { min: 50, max: 70, ratio: 0.06 },
			};
