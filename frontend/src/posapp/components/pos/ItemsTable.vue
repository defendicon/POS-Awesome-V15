...
:deep(.v-theme--dark) .dark-field :deep(.v-field__outline),
:deep([data-theme="dark"]) .dark-field :deep(.v-field__outline__start),
:deep(.v-theme--dark) .dark-field :deep(.v-field__outline__start),
:deep([data-theme="dark"]) .dark-field :deep(.v-field__outline__end),
:deep(.v-theme--dark) .dark-field :deep(.v-field__outline__end),
:deep([data-theme="dark"]) .dark-field :deep(.v-field__outline__notch),
:deep(.v-theme--dark) .dark-field :deep(.v-field__outline__notch),
::v-deep([data-theme="dark"]) .dark-field .v-field__outline,
::v-deep(.v-theme--dark) .dark-field .v-field__outline,
::v-deep([data-theme="dark"]) .dark-field .v-field__outline__start,
::v-deep(.v-theme--dark) .dark-field .v-field__outline__start,
::v-deep([data-theme="dark"]) .dark-field .v-field__outline__end,
...
:deep(.v-theme--dark) .dark-field :deep(.v-field__prepend-inner .v-icon),
:deep([data-theme="dark"]) .dark-field :deep(.v-field__append-inner .v-icon),
:deep(.v-theme--dark) .dark-field :deep(.v-field__append-inner .v-icon),
::v-deep([data-theme="dark"]) .dark-field .v-field__prepend-inner .v-icon,
