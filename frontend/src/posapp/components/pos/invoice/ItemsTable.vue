	...
	>
		...
		>
			<template v-slot:no-data>
				<div class="d-flex flex-column align-center justify-center py-10 text-medium-emphasis h-100 w-100">
					<v-icon icon="mdi-cart-outline" size="64" class="mb-4 text-disabled" />
					<div class="text-h6 font-weight-regular text-disabled">{{ __("Your cart is empty") }}</div>
					<div class="text-body-2 mt-2 text-center text-disabled" style="max-width: 300px">
