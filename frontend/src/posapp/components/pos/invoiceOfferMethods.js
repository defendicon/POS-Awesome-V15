...
export default {
	...
	ApplyOnTotal(offer) {
		...
		// Check if this exact offer is already applied with the same discount amount
		if (this.discount_percentage_offer_name === offer.name && 
		...
		if (
			...
			// Log for debugging
			console.log('Applied automatic discount offer:', {
				offer_name: offer.name,
