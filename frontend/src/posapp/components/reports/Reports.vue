...
import {
	type DashboardScope,
	useDashboardData,
} from "@/posapp/composables/dashboard/useDashboardData";
import { useUIStore } from "@/posapp/stores/uiStore";
import { isDebugFlagEnabled } from "@/posapp/utils/debug";
import {
...
const dashboardScope = ref<DashboardScope>("all");
...
const {
	...
	{
		isDebugEnabled: () => isDebugFlagEnabled("posawesome_debug_dashboard"),
		translate: __,
	},
);
