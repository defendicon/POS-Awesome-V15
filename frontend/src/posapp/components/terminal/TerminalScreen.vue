...
<script>
import ItemsSelector from "../catalog/CatalogBrowser.vue";
import Invoice from "../cart/Invoice.vue";
import OpeningDialog from "../shifts/ShiftOpeningDialog.vue";
import Payments from "../checkout/Payments.vue";
import PosOffers from "../pos/offers/PosOffers.vue";
import PosCoupons from "../pos/offers/PosCoupons.vue";
import Drafts from "../pos/flows/Drafts.vue";
import InvoiceManagement from "../pos/flows/InvoiceManagement.vue";
import SalesOrders from "../pos/flows/SalesOrders.vue";
import NewAddress from "../pos/customer/NewAddress.vue";
import Variants from "../catalog/CatalogVariants.vue";
import Returns from "../pos/flows/Returns.vue";
import MpesaPayments from "../checkout/CheckoutMpesaSection.vue";
...
export default {
	setup() {
		...
		const handleAdditionalDiscountUpdate = (value) => {
			cartStore.setAdditionalDiscount(value);
		};
		...
		const handleAdditionalDiscountPercentageUpdate = (value) => {
			cartStore.setAdditionalDiscountPercentage(value);
		};
