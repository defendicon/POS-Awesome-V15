...
import Customer from "../pos/customer/Customer.vue";
import {
	initPromise,
	checkDbHealth,
	setOpeningStorage,
...
// Composables
import { usePosPayData } from "../../composables/pos/checkout/useCheckoutPayData";
import { usePosPaySelection } from "../../composables/pos/checkout/useCheckoutPaySelection";
import { usePosPaySubmission } from "../../composables/pos/checkout/useCheckoutPaySubmission";
import {
	getAllowedPartyTypes,
	normalizePartyTypeForPaymentType,
	shouldShowReconciliationSections,
} from "../checkout-pay/checkoutPayModes";

// Sub-components
import PayInvoicesTable from "../checkout-pay/CheckoutPayInvoicesTable.vue";
import PayUnallocatedTable from "../checkout-pay/CheckoutPayUnallocatedTable.vue";
import PayMpesaSection from "../checkout-pay/CheckoutPayMpesa.vue";
import PayTotalsSidebar from "../checkout-pay/CheckoutPayTotalsSidebar.vue";
import PayActionButtons from "../checkout-pay/CheckoutPayActions.vue";
import PayPartySelector from "../checkout-pay/CheckoutPayPartySelector.vue";
...
} from "../../utils/checkoutRouteReadiness";
import { loadPaymentMethodCurrencyMap } from "../../utils/checkoutMethodCurrencyCache";
	...
	setup() {
		...
		const loadPaymentMethodCurrencies = async () => {
			...
			payment_method_currencies.value = await loadPaymentMethodCurrencyMap({
				...
				fetcher: async () => {
					const r = await frappe.call({
						method: "posawesome.posawesome.api.checkout_processing.utils.get_mode_of_payment_accounts",
