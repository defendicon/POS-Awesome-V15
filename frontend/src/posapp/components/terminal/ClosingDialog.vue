...
import { useClosingShift } from "../../composables/pos/shifts/useShiftClosing";
import { useClosingSummary } from "../../composables/pos/shifts/useShiftSummary";

import ClosingHeader from "../shifts/ShiftClosingHeader.vue";
import ShiftOverview from "../shifts/ShiftOverviewPanel.vue";
import PaymentReconciliation from "../shifts/ShiftReconciliation.vue";
...
export default {
	...
	setup() {
		...
		const summary = useShiftSummary(overview, pos_profile, dialog_data, summaryFormatters);
