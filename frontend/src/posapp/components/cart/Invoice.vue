...
import InvoiceCustomerSection from "./CartCustomerSection.vue";
import DeliveryCharges from "./CartDeliveryCharges.vue";
import PostingDateRow from "./CartPostingDateRow.vue";
import MultiCurrencyRow from "./CartMultiCurrencyRow.vue";
import CancelSaleDialog from "./CartCancelSaleDialog.vue";
import InvoiceSummary from "./CartSummaryPanel.vue";
import ItemsTable from "./CartItemsTable.vue";
import InvoiceItemsActionToolbar from "./CartItemsToolbar.vue";
import PackedItemsDialog from "./CartPackedItemsDialog.vue";
import PaymentConfirmationDialog from "./payments/PaymentConfirmationDialog.vue";
import PriceListRateDialog from "./CartPriceListRateDialog.vue";
import cartItemMethods from "./cartItemMethods";
import cartComputed from "./cartComputed";
import cartWatchers from "./cartWatchers";
import shortcutMethods from "./cartShortcuts";
...
import { save_and_clear_invoice as saveAndClearInvoiceAction } from "../cart-utils/actions";
import { fetchDraftInvoiceDoc, fetchDraftInvoices } from "../../utils/draftInvoices";

// Composables
import { useOnlineStatus } from "../../composables/core/useOnlineStatus";
import { useInvoiceCurrency } from "../../composables/pos/cart/useCartCurrency";
import { useInvoiceItems } from "../../composables/pos/cart/useCartItems";
import { useInvoiceOffers } from "../../composables/pos/cart/useCartOffers";
import { useInvoiceUI } from "../../composables/pos/cart/useCartUI";
import { useInvoicePrinting } from "../../composables/pos/cart/useCartPrinting";
import { useInvoiceStock } from "../../composables/pos/cart/useCartStock";
import { usePaymentPrinting } from "../../composables/checkout/usePaymentPrinting";
import {
	createcartShortcutListeners,
	registercartShortcutListener,
	unregistercartShortcutListener,
} from "../../utils/cartShortcutListener";
...
export default {
	...
	created() {
		...
		this._shortcutHandlers.handleInvoiceShortcut = createcartShortcutListeners(
