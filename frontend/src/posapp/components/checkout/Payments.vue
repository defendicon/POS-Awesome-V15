...
// Composables
import { usePaymentCalculations } from "../../composables/pos/checkout/useCheckoutCalculations";
import { usePaymentSubmission } from "../../composables/pos/checkout/useCheckoutSubmission";
import { useRedemptionLogic } from "../../composables/pos/checkout/useCheckoutRedemption";
import { usePaymentPrinting } from "../../composables/pos/checkout/useCheckoutPrinting";
import { usePaymentMethods } from "../../composables/pos/checkout/useCheckoutMethods";
import { useInvoiceDetails } from "../../composables/pos/cart/useCartDetails";
import { useFormat } from "../../format";
import { isOffline, getCachedGiftCardSnapshot, saveGiftCardSnapshot } from "../../../offline/index";
import GiftCardDialog from "../pos/wallet/GiftCardDialog.vue";
import {
	initializePaymentLinesForDialog,
	rebalancePreferredPaymentLine,
	resolvePreferredPaymentLine,
} from "../../utils/checkoutInitialization";
import { resolvePaymentPrintFormatDoctypes } from "../../utils/checkoutPrintDoctype";
import { resolvePaymentPrintFormat } from "../../utils/checkoutPrintFormat";
import { parseBooleanSetting } from "../../utils/stock";

// Components
import PaymentSummary from "./CheckoutSummaryPanel.vue";
import InvoiceTotals from "./CheckoutTotals.vue";
import PaymentActionButtons from "./CheckoutActionButtons.vue";
import PaymentMethods from "./CheckoutMethodsPanel.vue";
import PaymentGiftCardSection from "./CheckoutGiftCardSection.vue";
import PaymentRedemption from "./CheckoutRedemption.vue";
import PaymentAdditionalInfo from "./CheckoutAdditionalInfo.vue";
import PaymentPurchaseOrder from "./CheckoutPurchaseOrder.vue";
import PaymentCustomerCreditDetails from "./CheckoutCreditDetails.vue";
import PaymentOptions from "./CheckoutOptionsPanel.vue";
import PaymentSelectionFields from "./CheckoutSelectionFields.vue";
import PaymentDialogs from "./CheckoutDialogs.vue";
