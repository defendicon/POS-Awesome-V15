...
export interface CurrencyContext {
    ...
    flt: (value: number, precision?: number) => number;
}

/**
 * Gets the company currency from the context.
 */
export const getCompanyCurrency = (context: CurrencyContext): string | undefined =>
 ...
 */
export const toBaseCurrency = (context: CurrencyContext, amount: number | null | undefined): number | null | undefined => {
 ...
 */
export const toSelectedCurrency = (context: CurrencyContext, amount: number | null | undefined): number | null | undefined => {
    if (amount == null || isCompanyCurrencySelected(context)) {
        return amount;
    }
    const conversionRate = context.conversion_rate || 1;
