...
// Composables
import { useItemsCache } from "../composables/pos/catalog/store/useItemsCache";
import { useItemsSearch } from "../composables/pos/catalog/store/useItemsSearch";
import { useItemsSync } from "../composables/pos/catalog/store/useItemsSync";
import { useItemsPagination } from "../composables/pos/catalog/store/useItemsPagination";
import { useItemsMetrics } from "../composables/pos/catalog/store/useItemsMetrics";

export const useCatalogStore = defineStore("items", () => {
