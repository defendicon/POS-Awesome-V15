(function (e, t) {
	...
	function S(e) {
		...
		e = (function e(t) {
			...
			} else if (K.has(t.constructor)) n = t;
			else {
				var o,
					a = c(t);
					...
					e
						? "string" == typeof e
							? ((this.message = "".concat(e).concat(t ? "\n " + t : "")),
								(this.inner = t || null))
							: "object" == typeof e &&
								((this.message = "".concat(e.name, " ").concat(e.message)), (this.inner = e))
	...
	var ie =
		"undefined" != typeof location && /^(http|https):\/\/(localhost|127\.0\.0\.1)/.test(location.href);
	function oe(e) {
		ie = e;
	}
	var ae = {},
	...
	function We(e, t) {
		var n,
			r = me;
		((t ? !De.echoes || (Re++ && e === me) : !Re || (--Re && e === me)) ||
			queueMicrotask(
				t
					? function (e) {
							(++Fe,
								(De.echoes && 0 != --De.echoes) || (De.echoes = De.awaits = De.id = 0),
								Be.push(me),
								We(e, !0));
						}.bind(null, e)
					: ze,
	...
	var ft =
		((ht.prototype._trans = function (e, r, t) {
			var n = this._tx || me.trans,
				...
				o =
					...
					console.createTask &&
					console.createTask(
						"Dexie: ".concat("readonly" === e ? "read" : "write", " ").concat(this.name),
					);
			function a(e, t, n) {
		...
		(ht.prototype.where = function (o) {
			...
			var r = n.reduce(
				...
				r = r[1];
			return t
				? this.where(t.name).equals(o[t.keyPath]).filter(r)
				: e
					? this.filter(r)
					: this.where(n).equals("");
		}),
		...
		(ht.prototype.orderBy = function (e) {
			return new this.db.Collection(
				new this.db.WhereClause(this, k(e) ? "[".concat(e.join("+"), "]") : e),
			);
		}),
		...
		(ht.prototype.bulkDelete = function (t) {
			...
			return this._trans("readwrite", function (e) {
				...
				if (0 === t) return n;
				throw new V(
					"".concat(r.name, ".bulkDelete(): ").concat(t, " of ").concat(i, " operations failed"),
					e,
				);
			});
		}),
	...
	var xt =
		((kt.prototype.execute = function (e) {
			...
			if (void 0 !== t.add) {
				var n = t.add;
				if (k(n)) return i(i([], k(e) ? e : [], !0), n, !0).sort();
			...
			return n && "string" == typeof e && e.startsWith(n)
	...
	var Ot =
		...
		(Pt.prototype.count = function (e) {
			...
			return this._read(function (e) {
				...
				if (yt(t, !0))
					return n
						.count({ trans: e, query: { index: bt(t, n.schema), range: t.range } })
						.then(function (e) {
				...
				return n
					...
					.then(function (l) {
						function f(s) {
							...
							return y
								.getMany({ trans: d, keys: l.slice(s, s + c), cache: "immutable" })
								.then(function (e) {
									for (var n = [], t = [], r = v ? [] : null, i = [], o = 0; o < c; ++o) {
										...
										!1 !== p.call(u, u.value, u) &&
											(null == u.value
												? i.push(l[s + o])
												: v || 0 === st(m(a), m(u.value))
													? (t.push(u.value), v && r.push(l[s + o]))
													: (i.push(l[s + o]), n.push(u.value)));
									}
									return Promise.resolve(
										0 < n.length &&
											y.mutate({ trans: d, type: "add", values: n }).then(function (e) {
						...
						var h = yt(r) &&
							r.limit === 1 / 0 &&
							("function" != typeof w || w === Kt) && { index: r.index, range: r.range };
	...
	var Ft = "storagemutated",
		...
		Lt =
			...
			(Ut.prototype.abort = function () {
				this.active &&
					((this.active = !1), this.idbtrans && this.idbtrans.abort(), this._reject(new Y.Abort()));
			}),
			...
			return {
				...
				mutate: function (e) {
					...
					return new Promise(function (t, e) {
						...
						if (0 === a)
							return t({ numFailures: 0, failures: {}, results: [], lastResult: void 0 });
						function u(e) {
							(++l, Rt(e));
						}
						var s = [],
						...
						if ("deleteRange" === v) {
							...
							if (i)
								for (var d = 0; d < a; ++d)
									(s.push((o = h && void 0 !== h[d] ? n[v](f[d], h[d]) : n[v](f[d]))),
										(o.onerror = u));
				...
				getMany: function (e) {
					...
					return new Promise(function (t, e) {
						...
						for (
							...
							null != h[l] &&
								(((n = r.get(h[l]))._pos = l), (n.onsuccess = s), (n.onerror = c), ++a);
						0 === a && t(o);
					});
				},
				get: function (e) {
												...
												(t.push(function () {
													...
													if (r && u._cfg.version > c) {
														...
														(n.del.forEach(function (e) {
															...
															en(s, [s.Transaction.prototype], x(i), i),
															(l.schema = i));
														var o,
															a = B(r);
														a && Le();
		...
		for (var n = 0, i = an(t, e._dbSchema).change; n < i.length; n++) {
			var o = (function (t) {
				...
				t.add.forEach(function (e) {
					(ie &&
						console.debug(
							"Dexie upgrade patch: Creating missing index ".concat(t.name, ".").concat(e.src),
						),
						cn(n, e));
				});
			})(i[n]);
	...
	var dn =
		...
		(pn.prototype.stores = function (e) {
			...
			return (
				...
				en(t, [t._allTables, t, t.Transaction.prototype, this._cfg.tables], x(r), r),
				(t._storeNames = x(r)),
				this
			);
		}),
			...
			next: function (e) {
				for (var t = 0 < arguments.length; n; )
					switch (n.s) {
						case 0:
							if (((n.s = 1), t))
								for (; n.n.l && st(e, n.n.from) < 0; ) n = { up: n, n: n.n.l, s: 1 };
				...
				t[e]
					...
					: (t[e] = (function e(t) {
							...
							for (n in t)
								m(t, n) &&
									((r = t[n]),
									(i[n] = !r || "object" != typeof r || K.has(r.constructor) ? r : e(r)));
							return i;
						})(n[e]));
			}),
			t
	...
	function Tn(e, t) {
		void 0 === t && (t = !1);
		var n = new Set();
		if (e.all) for (var r = 0, i = Object.values(Sn); r < i.length; r++) qn((a = i[r]), e, n, t);
		else
			for (var o in e) {
				var a,
					u = /^idb\:\/\/(.*)\/(.*)\//.exec(o);
					...
					m &&
						...
						f.tables.forEach(function (t) {
							(t.schema.indexes.forEach(function (e) {
								e.name &&
									(n["idb://".concat(f.name, "/").concat(t.name, "/").concat(e.name)] =
										new gn(-1 / 0, [[[]]]));
							}),
										...
										function () {
											return (function n(r, i, o) {
												return y
													...
													.then(function (e) {
														var t = e.result;
														return a({ type: "delete", keys: t, trans: r }).then(
															function (e) {
									...
									"delete" !==
										(c =
											"add" === c.type || "put" === c.type
												? _(_({}, c), { keys: f })
												: _({}, c)).type && (c.values = i([], c.values, !0)),
				...
				transaction: function (e, t, n) {
					if (me.subscr && "readonly" !== t)
						throw new Y.ReadOnly(
							"Readwrite transaction in liveQuery context. Querier source: ".concat(me.querier),
						);
					...
					var p = b.table(d),
						...
						t = _(_({}, p), {
							mutate: function (a) {
								...
								return (
									k(f)
										? (r.addKeys(f),
											(l = "delete" === c || f.length === h.length ? Ln(f, l) : null) ||
												i.addKeys(f),
											(l || h) &&
												((e = u),
												(o = l),
										...
										: f
											? ((h = {
													from:
														null !== (h = f.lower) && void 0 !== h
															? h
															: b.MIN_KEY,
													to:
														null !== (h = f.upper) && void 0 !== h
															? h
															: b.MAX_KEY,
												}),
												i.add(h),
									...
									p.mutate(a).then(function (o) {
										return (
											!f ||
												("add" !== a.type && "put" !== a.type) ||
												(r.addKeys(o.results),
												m &&
													m.forEach(function (t) {
														for (
															var e = a.values.map(function (e) {
											...
											(t.mutatedParts = Kn(t.mutatedParts || {}, n)),
											o
										);
									})
								);
						...
						e = function (e) {
							...
							return [
								e,
								new gn(
									null !== (e = t.lower) && void 0 !== e ? e : b.MIN_KEY,
									null !== (t = t.upper) && void 0 !== t ? t : b.MAX_KEY,
								),
							];
						},
						f = {
		...
		return t === e
			...
			: (t.sort(function (e, t) {
				...
				d.limit &&
					...
					(t.length > d.limit
						? (t.length = d.limit)
						: e.length === d.limit && t.length < d.limit && (r.dirty = !0)),
				i ? Object.freeze(t) : t);
	}
	function Gn(e, t) {
		return (
												...
												if (x._explicit && b && x.mutatedParts)
													for (
														...
														for (
															...
															En((p = l[c]).obsSet, x.mutatedParts) &&
																(q(d, p),
				...
				table: function (c) {
					...
					return _(_({}, l), {
						...
						query: function (t) {
							...
							var i =
									"immutable" ===
									(null === (o = me.trans) || void 0 === o ? void 0 : o.db._options.cache),
								e = me,
								n = e.requery,
								r = e.signal,
								o = (function (e, t, n, r) {
				...
				return _e.resolve().then(function () {
					...
					if (((t.explicit = !0), (e = { trans: t, transless: e }), s)) t.idbtrans = s.idbtrans;
						...
						try {
							...
							return e.name === z.InvalidState && o.isOpen() && 0 < --o._state.PR1398_maxLoop
								? (console.warn("Dexie: Need to reopen db"),
	...
	function tr(e, t) {
		...
		((c.dbReadyPromise = new _e(function (e) {
			...
			(this.Collection =
				...
				pt(Ot.prototype, function (e, t) {
					...
					this._ctx = {
						...
						index: i.index,
						isPrimKey:
							!i.index || (t.schema.primKey.keyPath && i.index === t.schema.primKey.name),
						range: n,
						keysOnly: !1,
						dir: "next",
						unique: "",
			...
			(this.WhereClause =
				((s = this),
				pt(Dt.prototype, function (e, t, n) {
					if (
						((this.db = s),
