...
from posawesome.posawesome.api.catalog_processing.barcode import search_serial_or_batch_or_barcode_number
from posawesome.posawesome.api.catalog_processing.details import get_items_details
