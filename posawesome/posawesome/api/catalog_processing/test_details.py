...
def _install_dependency_stubs():
    ...
    stock_module = types.ModuleType("posawesome.posawesome.api.catalog_processing.stock")
    stock_module.get_stock_availability = lambda *args, **kwargs: 0
    sys.modules["posawesome.posawesome.api.catalog_processing.stock"] = stock_module
...
def _install_package_stubs():
    package_paths = {
        ...
        "posawesome.posawesome.api.catalog_processing": (
...
def _load_module():
    module_name = "posawesome.posawesome.api.catalog_processing.details"
