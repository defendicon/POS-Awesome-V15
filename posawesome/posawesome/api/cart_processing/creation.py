...
from posawesome.posawesome.api.cart_processing.utils import (
...
from posawesome.posawesome.api.cart_processing.stock import (
...
def _run_post_submit_payments(invoice_doc, data, is_payment_entry, total_cash, cash_account, payments):
    from posawesome.posawesome.api.cart_processing.payment import _create_change_payment_entries
...
def update_invoice(data):
    ...
    if (data.get("is_return") or invoice_doc.is_return) and invoice_doc.get("return_against"):
        ...
        from posawesome.posawesome.api.cart_processing.returns import validate_return_items
