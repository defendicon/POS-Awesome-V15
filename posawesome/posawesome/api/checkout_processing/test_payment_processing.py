...
def _install_package_stubs():
    package_paths = {
        ...
        "posawesome.posawesome.api.checkout_processing": (
...
class TestPosPaymentProcessing(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        _load_module(
            "posawesome.posawesome.api.checkout_processing.utils",
            payment_processing_dir / "utils.py",
        )
        _load_module(
            "posawesome.posawesome.api.checkout_processing.creation",
            payment_processing_dir / "creation.py",
        )
        cls.data = _load_module(
            "posawesome.posawesome.api.checkout_processing.data",
            payment_processing_dir / "data.py",
        )
        cls.processor = _load_module(
            "posawesome.posawesome.api.checkout_processing.processor",
            payment_processing_dir / "processor.py",
        )
        cls.reconciliation = _load_module(
            "posawesome.posawesome.api.checkout_processing.reconciliation",
            payment_processing_dir / "reconciliation.py",
        )

    @patch("posawesome.posawesome.api.checkout_processing.processor.create_payment_entry")
    @patch("posawesome.posawesome.api.checkout_processing.processor.frappe")
    ...
    @patch(
        "posawesome.posawesome.api.checkout_processing.data.get_advance_payment_entries_for_regional"
    )
    @patch("posawesome.posawesome.api.checkout_processing.data.get_party_account")
    @patch("posawesome.posawesome.api.checkout_processing.data.frappe")
    ...
    @patch(
        "posawesome.posawesome.api.checkout_processing.data.get_erpnext_outstanding_invoices",
    ...
    @patch("posawesome.posawesome.api.checkout_processing.reconciliation.reconcile_against_document")
    @patch("posawesome.posawesome.api.checkout_processing.reconciliation.frappe")
    @patch("posawesome.posawesome.api.checkout_processing.reconciliation.get_unallocated_payments")
    @patch("posawesome.posawesome.api.checkout_processing.reconciliation.get_outstanding_invoices")
