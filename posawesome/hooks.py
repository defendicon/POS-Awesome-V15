        ...
        "filters": [
            [
                ...
                (
                    ...
                    "POS Profile-posa_show_expired_batches",
                    "POS Profile-posa_expired_batch_behaviour",
                    "POS Profile-posa_col_1",
                    "POS Profile-create_pos_invoice_instead_of_sales_invoice",
                    "POS Invoice-posa_is_printed",
                    "POS Invoice Item-posa_allow_expired_batch",
                    "Sales Invoice-posa_is_printed",
                    "Sales Invoice Item-posa_allow_expired_batch",
